...
public class UserDetailsServiceImpl implements SAMLUserDetailsService {
	...
	public Object loadUserBySAML(SAMLCredential samlCred) throws UsernameNotFoundException {
        ...
        try {
            ...
            String username = samlCred.getAttributeAsString(FIRST_NAME_KEY) + " " + samlCred.getAttributeAsString(LAST_NAME_KEY);
        	...
        	if(isUserAuthorized) {
            	LOGGER.info("User is authorized to access Item Viewer Service");
        	}
        	else {
        		LOGGER.info("User is NOT authorized to access Item Viewer Service");
        	}
